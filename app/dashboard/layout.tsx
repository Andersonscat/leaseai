...
import { Inbox, Home, BarChart3, CreditCard, Sparkles, FileText, Users, Settings, LogOut, User as UserIcon, Calendar, MessageSquare, Briefcase, Palette, HelpCircle, ChevronRight, PanelLeftClose, PanelLeftOpen, MoreVertical, Megaphone, PanelRightOpen, PanelRightClose, Crown, Bot, Beaker, Play } from "lucide-react";
          ...
          <nav className="flex-1 min-h-0 overflow-y-auto py-5 px-3 scrollbar-hide">
             ...
             <div className="space-y-1">
               ...
               {[
                 ...
                 { tab: 'simulate', icon: Play, label: 'Simulate' },
